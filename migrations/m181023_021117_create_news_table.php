...
class m181023_021117_create_news_table extends Migration
{
    ...
    public function up()
    {
        ...
        $this->createTable('JP_blogRecord',[
            ...
            'sinaType'  => $this->smallInteger(64)->comment('sina博客分类，逗号分隔'),
            'csdnType'  => $this->smallInteger(64)->comment('csdn博客分类，逗号分隔'),
            '163Type'  => $this->smallInteger(64)->comment('163博客分类'),
            'oschinaType'  => $this->smallInteger(64)->comment('oschina博客分类'),
            'chinaunixType'  => $this->smallInteger(64)->comment('chinaunix博客分类'),
        ],$tableOptions);
